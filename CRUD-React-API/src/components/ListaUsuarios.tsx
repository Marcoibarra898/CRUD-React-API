            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-50">
                  ...
                  <th className="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Fecha Registro</th>
                ...
                {usuariosFiltrados.length > 0 ? (
                  usuariosFiltrados.map(usuario => (
                    <tr key={usuario.id} className="hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4 whitespace-nowrap">{usuario.email}</td>
                      <td className="py-3 px-4 whitespace-nowrap">{usuario.telefono}</td>
                      <td className="py-3 px-4 whitespace-nowrap">
                        {usuario.fechaRegistro?.toLocaleDateString()}
                      </td>
                      <td className="py-3 px-4 whitespace-nowrap">
                        <div className="flex space-x-2">
                          <button className="text-blue-600 hover:text-blue-800" onClick={() => usuario.id !== undefined && onEdit(usuario.id)}>
                            <Edit size={18} />
                          </button>
                          <button 
